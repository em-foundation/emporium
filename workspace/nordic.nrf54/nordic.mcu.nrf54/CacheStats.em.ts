...
export function start() {
    ...
    $R.APPLICATION_ICACHE.PROFILING.READS.$$ = 0
    $R.APPLICATION_ICACHE.PROFILING.WRITES.$$ = 0
    $R.APPLICATION_ICACHE.PROFILING.HIT.$$ = 0
    $R.APPLICATION_ICACHE.PROFILING.MISS.$$ = 0
    $R.APPLICATION_ICACHE.PROFILING.LMISS.$$ = 0
}
